...
def trade_date_sse(start_dt='2020-01-01', end_dt='2030-12-31'):
    if os.path.exists("trade_date_sse.pkl"):
        df = pd.read_pickle("trade_date_sse.pkl")
    else:
...
if __name__ == "__main__":
    print(get_trading_calendar()) #start_dt="2021-01-01",end_dt="2022-12-31"))
    print(trade_date_cn)
